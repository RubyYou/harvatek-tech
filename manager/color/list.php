...
<div id="wrapper">
  <div id="header">
    <div id="path_wrap">Color > List</div>
  </div>
  <div id="main">
    <div id="list_wrap">
      ...
      <table id="data_wrap" class="fancyTable">
          ...
          ?>
			  <tr>
				...
				<td class="sysimg">
					<a href="update.php?color_id=<?php echo $page['data'][$key]['color_id']?>&nowpage=<?php echo $nowpage?>"><img src="../images/edit.gif" width="24" height="24" border="0"></a>
				</td>
					<td class="sysimg">
					  <a href="delete.php?color_id=<?php echo $page['data'][$key]['color_id']?>&nowpage=<?php echo $nowpage;?>"><img src="../images/del.gif" width="24" height="24" border="0"></a> 
					</td>
			  </tr>
          <?php
			}
