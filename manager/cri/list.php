      ...
      <table id="data_wrap" class="fancyTable">
          ...
          ?>
			  <tr>
				...
				<td class="sysimg">
					<a href="update.php?cri_id=<?php echo $page['data'][$key]['cri_id']?>&nowpage=<?php echo $nowpage?>"><img src="../images/edit.gif" width="24" height="24" border="0"></a>
				</td>
					<td class="sysimg">
					  <a href="delete.php?cri_id=<?php echo $page['data'][$key]['cri_id']?>&nowpage=<?php echo $nowpage;?>"><img src="../images/del.gif" width="24" height="24" border="0"></a> 
					</td>
			  </tr>
          <?php
			}
