...
<div id="wrapper">
  <div id="header">
    <div id="path_wrap">Contact > List</div>
  </div>
  <div id="main">
    <div id="list_wrap">
          ...
          ?>
			  <tr>
				<td class="aligncenter">
					<?php echo $page['data'][$key]['add_time'];?>
				</td>
				<td class="aligncenter">
					<?php echo $page['data'][$key]['name'];?>
				</td>
				<td class="sysimg">
					<a href="update.php?contact_id=<?php echo $page['data'][$key]['contact_id']?>&nowpage=<?php echo $nowpage?>"><img src="../images/edit.gif" width="24" height="24" border="0"></a>
				</td>
					<td class="sysimg">
					  <a href="delete.php?contact_id=<?php echo $page['data'][$key]['contact_id']?>&nowpage=<?php echo $nowpage;?>"><img src="../images/del.gif" width="24" height="24" border="0"></a> 
					</td>
			  </tr>
          <?php
			}
