...
<!-- page: applications
================================================== -->
		<p >Designing components to meet the needs of a wide range of design and efficiency requirement,<br/>
			Harvatek Technologies offers high quality and competitive LED solutions for industries across the globe.</p>

		<ul class="nav nav-tabs">
			<li class="active"><a href="#tabs-1" data-toggle="tab">General Lighting</a></li>
			<li><a href="#tabs-2" data-toggle="tab">Display</a></li>
			<li><a href="#tabs-3" data-toggle="tab">Infrared</a></li>
			<li><a href="#tabs-4" data-toggle="tab">SMD LED</a></li>
			<li><a href="#tabs-5" data-toggle="tab">UV</a></li>
		</ul>

		<div class="tab-content">
			<div id="tabs-1" class="tab-pane active">
				<h3>General Lighting</h3>
				<img class="alignleft size-full" alt="general_lighting" src="http://harvatek-tech.com/wp-content/uploads/2014/04/app_generallighting.jpg" usemap="#Map" width="1000" height="426" border="0" />
				<map name="Map" id="Map">
			...
			<div id="tabs-2" class="tab-pane">
				...
				<img class="alignleft size-full" alt="general_lighting" src="http://harvatek-tech.com/wp-content/uploads/2014/04/app_display.jpg" width="1000" height="418" border="0" />
			</div>
			<div id="tabs-3" class="tab-pane">
				<h3>Infrared Application</h3>
				<img class="alignleft size-full" alt="general_lighting" src="http://harvatek-tech.com/wp-content/uploads/2014/04/app_infrared1.jpg" width="1000" height="438" border="0" />
				<img class="alignleft size-full" alt="general_lighting" src="http://harvatek-tech.com/wp-content/uploads/2014/04/app_infrared2.jpg" width="1000" height="432" border="0" />
			</div> 
			<div id="tabs-4" class="tab-pane">
				<h3>SMD LED Application</h3>
				<img class="alignleft size-full" alt="SMD LED" src="http://harvatek-tech.com/wp-content/uploads/2014/04/app_smd.jpg" usemap="#Map2" width="1000" height="921" border="0" />
