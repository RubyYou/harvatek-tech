...
<div class="row salesRepo">
	<ul class="col-sm-4">
		...
		<li><a href="mailto:kfecteau@oasis-sales.com">kfecteau@oasis-sales.com</a></li>
	...
	<ul class="col-sm-4">
		...
		<li>Massachusetts, Maine, Vermont, Rhode Island and Connecticut</li>
	...
	<ul class="col-sm-4">
		...
		<li><a href="mailto:sales@dyneamark.com"> sales@dyneamark.com</a></li>
		<li><i class="fa fa-phone"></i> 407-660-1661</li>
		<li><i class="fa fa-print"></i> 407-660-9407</li>
...
<div class="row salesRepo">
	<ul class="col-sm-4">
		...
		<li>Northern California, Northern Nevada</li>
	...
	<ul class="col-sm-4">
		...
		<li>Indiana, Kentucky, Michigan, Ohio, Western Pennsylvania, and West Virginia</li>
...
<div class="row salesRepo">
	<ul class="col-sm-4">
		...
		<li>Colorado, Utah</li>
		<li><a href="mailto:sales@eagleridgemktg.com">sales@eagleridgemktg.com</a></li>
		<li><i class="fa fa-phone"></i> 303-215-9182</li>
		<li><i class="fa fa-mobile"></i> &nbsp;303-667-2699</li>
		<li><a href="http://www.eagleridgemktg.com/" target="_blank">www.eagleridgemktg.com</a></li>
	</ul>
	<ul class="col-sm-4">
		<li style="color:#938eff;">Tech Coast Sales</li>
		<li>Southern California, Southern Nevada, Arizona, New Mexico</li>
		<li><a href="mailto:sales@tc-sales.com">sales@tc-sales.com</a></li>
		<li><i class="fa fa-phone"></i> 949-305-6869</li>
		<li><i class="fa fa-print"></i> 949-305-4073</li>
		<li><a href="http://tc-sales.com/" target="_blank">tc-sales.com</a></li>
	</ul>
	<ul class="col-sm-4">
